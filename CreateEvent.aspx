        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style2">
                    <asp:Label ID="lblCreateEvent" runat="server" Text="Create Event"></asp:Label>
                </td>
                <td class="auto-style3">&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td class="auto-style3">
                    <asp:TextBox ID="txtEventDescription" runat="server" Height="96px" Width="231px"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                <td>&nbsp;</td>
                <td class="auto-style2">
                    <asp:Button ID="btnCalender" runat="server" Text="Send to Calender" Width="150" />
                </td>
                <td class="auto-style3">
                    &nbsp;</td>
                <td>&nbsp;</td>
